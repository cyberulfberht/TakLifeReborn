...
if (_jammed == 1) exitWith {hintSilent localize "STRS_inventar_stoersender_alreadyinuse";};
_dauer = (10 * 60);
call compile format ["%1_markerjammed = 1; publicVariable ""%1_markerjammed"";",_civ];
hintSilent format [localize "STRS_inventar_stoersender_success",(stoersender_dauer call ISSE_str_IntToStr)];
showMap false;
...
if (call compile format ["%1_markerjammed == 1",_civ]) then
	...
	hintSilent localize "STRS_inventar_stoersender_end";
	showMap true;
